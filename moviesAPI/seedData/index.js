...
import InCinemaModel from '../api/inCinemaMovies/InCinemaModel';
import nowPlaying from './inCinema';
...
export async function loadInCinemaMovies() {
  ...
  try {
    await InCinemaModel.deleteMany();
    await InCinemaModel.collection.insertMany(nowPlaying);
